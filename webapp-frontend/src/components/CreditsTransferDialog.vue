            ...
            <template v-slot:item="{ props, item }">
              <v-list-item v-bind="props">
                ...
                <v-list-item-subtitle style="color: rgba(0, 0, 0, 0.87); font-weight: 500;">
                  ...
                  <span v-if="item.raw.current_credits > 0" style="color: rgba(255, 255, 255, 0.5);">
                    · 当前积分: <span style="color: rgba(255, 255, 255, 0.5);">{{ item.raw.current_credits.toFixed(2) }}</span>
                  </span>
