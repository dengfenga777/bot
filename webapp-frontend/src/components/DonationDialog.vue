          ...
          >
            <template v-slot:item="{ props, item }">
              <v-list-item v-bind="props">
                ...
                <v-list-item-subtitle style="color: rgba(0, 0, 0, 0.87); font-weight: 500;">
                  <span style="color: rgba(255, 255, 255, 0.5);">ID:</span> <span style="color: rgba(255, 255, 255, 0.5);">{{ item.raw.tg_id }}</span>
                  <span v-if="item.raw.current_donation > 0" style="color: rgba(255, 255, 255, 0.5);">
                    · 当前捐赠: <span style="color: rgba(255, 255, 255, 0.5);">{{ item.raw.current_donation.toFixed(2) }}元</span>
                  </span>
